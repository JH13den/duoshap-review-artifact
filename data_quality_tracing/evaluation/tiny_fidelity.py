...
#!/usr/bin/env python3
"""
eval_inrun_fidelity_multibatch_shard_tinystories33m.py

Multi-batch fidelity check for TinyStories-33M / TinyStories.
...
from duoshap_tiny import (
    SODAInRunConfig,
    set_seed,
    load_blocked_tinystories_subsets,
    backup_params,
    restore_params,
    compute_val_loss,
...
class FidelityEvalConfig:
    output_dir: str = "../output/eval_exp2_fidelity_multibatch_tinystories33m"
    seed: int = 42
...
def parse_args() -> FidelityEvalConfig:
    ...
    parser.add_argument("--output_dir", type=str, default="../output/eval_exp2_fidelity_multibatch_tinystories33m")
    ...
    parser.add_argument("--N_per_i", type=int, default=5)
...
def main() -> None:
    ...
    train_loader, val_loader, val_inputs_default = load_blocked_tinystories_subsets(cfg, device)
    ...
    print("[DONE] TinyStories multi-batch shard finished successfully.")
